  ...
  return (
    <>
      <PageHeader
        ...
        description="ASC WORKING V1.9.2 chuẩn hóa Danh mục PLHĐ là nguồn dữ liệu chính, bổ sung Danh mục chi tiết PLHĐ và đồng bộ lưới PLHĐ bên ngoài."
      />
      ...
      >
        ...
        <div>
          ...
          <div className="mt-1 text-xs leading-5 text-slate-600">Chạy automated readiness, kiểm tra RLS/schema/security environment, Portfolio, Catalog Delete và regression testcase cho V1.9.2.</div>
        </div>
      ...
      <div className="tech-panel mt-4 rounded-2xl p-5 md:p-6">
        ...
        <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="text-lg font-semibold text-white">ASC WORKING V1.9.2</div>
            <div className="mt-1 text-xs text-slate-500">Catalog Source of Truth</div>
          </div>
