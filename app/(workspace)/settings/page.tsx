  ...
  return (
    <>
      <PageHeader
        ...
        description="ASC WORKING V1.3.0 mở rộng bản Production Release của Project Workspace đa dự án: Dashboard, PLHĐ, Phòng ban, ISSUE, Project Team, Excel Import và Remote Server Security đã được hợp nhất để vận hành production."
      />
      ...
      >
        ...
        <div>
          ...
          <div className="mt-1 text-xs leading-5 text-slate-600">Chạy automated readiness, kiểm tra RLS/schema/security environment và đánh dấu regression testcase cho V1.3.0.</div>
        </div>
      ...
      <div className="tech-panel mt-4 rounded-2xl p-5 md:p-6">
        ...
        <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="text-lg font-semibold text-white">ASC WORKING V1.3.0</div>
