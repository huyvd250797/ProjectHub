  ...
  return (
    <>
      <PageHeader
        ...
        description="ASC WORKING V2.2.2 bổ sung Global Data Grid UX: kéo đổi vị trí cột, resize độ rộng cột và hiển thị đủ nội dung dài trên các lưới dữ liệu."
      />
      ...
      >
        ...
        <div>
          ...
          <div className="mt-1 text-xs leading-5 text-slate-600">Chạy automated readiness, kiểm tra RLS/schema/security environment, Command Center, Portfolio, Catalog Delete, Global Data Grid UX và regression testcase cho V2.2.2.</div>
        </div>
      ...
      <div className="tech-panel mt-4 rounded-2xl p-5 md:p-6">
        ...
        <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="text-lg font-semibold text-white">ASC WORKING V2.2.2</div>
            <div className="mt-1 text-xs text-slate-500">Global Data Grid UX</div>
          </div>
