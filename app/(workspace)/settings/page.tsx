  ...
  return (
    <>
      <PageHeader
        ...
        description="ASC WORKING V2.6.0 bổ sung Resource Scheduling & Assignment Board: điều phối nhân sự theo tuần, kéo thả phân công ISSUE/task và date picker nhập/chọn DD/MM/YYYY."
      />
      ...
      >
        ...
        <div>
          ...
          <div className="mt-1 text-xs leading-5 text-slate-600">Chạy automated readiness, kiểm tra RLS/schema/security environment, Command Center, Portfolio, Catalog Delete, Resource Scheduling và regression testcase cho V2.6.0.</div>
        </div>
      ...
      <div className="tech-panel mt-4 rounded-2xl p-5 md:p-6">
        ...
        <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="text-lg font-semibold text-white">ASC WORKING V2.6.0</div>
            <div className="mt-1 text-xs text-slate-500">Resource Scheduling & Assignment Board</div>
          </div>
