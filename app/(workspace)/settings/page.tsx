  ...
  return (
    <>
      <PageHeader
        ...
        description="ASC WORKING V2.2.1 bổ sung PLHĐ Grid UX & Jira Code Display: nhập ngày bắt đầu/kết thúc để app tự đề xuất stage, số ngày và milestone."
      />
      ...
      >
        ...
        <div>
          ...
          <div className="mt-1 text-xs leading-5 text-slate-600">Chạy automated readiness, kiểm tra RLS/schema/security environment, Command Center, Portfolio, Catalog Delete, PLHĐ Grid UX & Jira Code Display và regression testcase cho V2.2.1.</div>
        </div>
      ...
      <div className="tech-panel mt-4 rounded-2xl p-5 md:p-6">
        ...
        <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="text-lg font-semibold text-white">ASC WORKING V2.2.1</div>
            <div className="mt-1 text-xs text-slate-500">PLHĐ Grid UX & Jira Code Display</div>
          </div>
