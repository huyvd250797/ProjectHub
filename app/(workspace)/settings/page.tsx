  ...
  return (
    <>
      <PageHeader
        ...
        description="ASC WORKING V3.0.0 bổ sung Enterprise Project Suite: chuẩn hóa lớp quản trị PMO, maturity score, readiness gates, operating model và priority board."
      />
      ...
      >
        ...
        <div>
          ...
          <div className="mt-1 text-xs leading-5 text-slate-600">Chạy automated readiness, kiểm tra RLS/schema/security environment, Command Center, Portfolio, Resource Scheduling, Enterprise Suite và regression testcase cho V3.0.0.</div>
        </div>
      ...
      <div className="tech-panel mt-4 rounded-2xl p-5 md:p-6">
        ...
        <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="text-lg font-semibold text-white">ASC WORKING V3.0.0</div>
            <div className="mt-1 text-xs text-slate-500">Enterprise Project Suite</div>
          </div>
