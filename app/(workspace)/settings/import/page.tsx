  ...
  return (
    <>
      <PageHeader
        ...
        description="Dry-run workbook theo project đang chọn: kiểm tra cấu trúc, mapping và chất lượng dữ liệu trước khi ghi vào PostgreSQL. Import POC vẫn là dry-run; Apply Import chưa được bật trong V0.4.0."
        actions={
