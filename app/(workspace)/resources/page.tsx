        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-amber-100/50">
              Username/password trong workbook không được hard-code hoặc trả về từ Import POC. V0.8.0 sẽ bổ sung encryption server-only, quyền Reveal/Copy và audit log.
            </p>
          </div>
        </div>
      </div>
