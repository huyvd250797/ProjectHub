...
export type IssueViewsApiResponse =
  | { ok: true; views: IssueSavedView[] }
  | { ok: false; code: string; message: string };

export type IssuePreferencesApiResponse =
  | { ok: true; preferences: IssueColumnPreferences }
  | { ok: false; code: string; message: string };

export type IssueBulkMutationResponse =
