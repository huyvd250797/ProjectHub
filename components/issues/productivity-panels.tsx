...
export const ISSUE_COLUMNS: Array<{ id: IssueColumnId; label: string; min: number; max: number }> = [
  ...
  { id: "stage", label: "Giai đoạn", min: 120, max: 240 },
  { id: "module", label: "Module", min: 130, max: 360 },
  { id: "department", label: "Phòng ban", min: 130, max: 320 },
  { id: "requester", label: "Nhân sự yêu cầu", min: 130, max: 300 },
  { id: "assignee", label: "Phụ trách", min: 120, max: 280 },
  { id: "dueDate", label: "Due Date", min: 105, max: 170 },
  { id: "releaseDate", label: "Ngày release", min: 110, max: 180 },
  { id: "estimatedHours", label: "Est. Hours", min: 96, max: 150 },
  { id: "response", label: "ASC phản hồi", min: 220, max: 520 },
  { id: "notes", label: "Ghi chú", min: 180, max: 460 },
...
export const DEFAULT_ISSUE_PREFERENCES: IssueColumnPreferences = {
  ...
  columnWidths: Object.fromEntries(ISSUE_COLUMNS.map((item) => [item.id, item.id === "content" ? 420 : item.id === "response" ? 280 : item.id === "notes" ? 240 : item.id === "issueNo" ? 82 : item.id === "jira" ? 140 : 160])),
